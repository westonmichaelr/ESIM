...
<html lang="en">
	...
	<body>
		...
		<h2>CHECK-OUT QUEUE:</h2>

			<!-- List of items being checked in -->
			<form action="CheckOut_2.php" id="item_list" method="post">
				...
				<button type="submit" id ="submit_button" class="submit_button">SUBMIT CHECK-OUT &#187;</button>
			...
			window.onload = function() {
				...
				function add_items() {
						...
						if (['Blazers', 'Coats', 'Earpieces', 'Jackets', 'Polos', 'Ponchos', 'Radios', 'Sweaters', 'Tags'].indexOf(item) >= 0) {
									...
									var array2 = ["Checking out", "*Getting Repaired"];

...
<html lang="en">
	<head>
      <meta charset="utf-8">
      <title>CheckIn_3 Page</title>
	    <!-- Stylesheet -->
	    <link rel="stylesheet" href="css/CheckIn_3.css">
	</head>
	...
	<body>
		...
		<!-- <div id="rwd"></div> -->
			...
			<?php
				...
				/* UPDATING DATABASE SECTION */
						...
						$sql = "UPDATE employees SET blazerid = NULL, poloid = NULL,
						sweaterid = NULL, jacketid = NULL, ponchoid = NULL,
						coatid = NULL, radioid = NULL, earid = NULL, tagid = NULL,
						checkout_time = '0000-00-00 00:00:00' WHERE EmpID = '$employee';";
						...
						// THIS IS FOR RADIOS ONLY
								// Radio Statement 1- Not getting marked for repair (normal checkin)
								if ($Radio_status != "*Done w/repair") {
										$sql .= "UPDATE radios SET in_quantity = (in_quantity + '$Radio_qty'), out_quantity = (out_quantity - '$Radio_qty');";
								}
								// Radio Statement 2- Getting marked as repaired
								else {
						...
						if (mysqli_multi_query($conn, $sql)) {
							 echo "<div class='confirmation_div'><h2>Check-In Successful!!</h2>"
											 	. "<p> Check-In time: ". $current_time . "</p>"
		...
		<button onclick=location.href="https://cgi.soic.indiana.edu/~team59/app/CheckIn_1.php" class="check_in_again">Check-in another item</button>
			<p class="or">OR</p>
		...
		<!-- Return to CheckIn_1 -->
		<button onclick=location.href="https://cgi.soic.indiana.edu/~team59/app/CheckOut_1.php" class="go_back">Check-In</button>
